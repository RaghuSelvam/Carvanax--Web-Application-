      ...
      {Object.entries(formData).map(([key, value]) => (
        <div className="form-group" key={key}>
          ...
          <input
            ...
            onPaste={(e) => (key === "password" || key === "confirmPassword") && e.preventDefault()}
          />
          {errors[key] && <div className="error-message" style={{ color: 'red' }}>{errors[key]}</div>}
        </div>
      ))}
...
//         <input
//           className={`form-input ${errors.interests ? "error-border" : ""}`}
//           type="text"
//           name="interests"
